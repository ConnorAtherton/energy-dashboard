...
!function(t){function e(){function t(t,e){t.attr("transform",function(t){return"translate("+(e(t)+h)+", 0)"})}function e(t,e){t.attr("transform",function(t){return"translate(0,"+e(t)+")"})}function n(t){var e=t[0];return t=t[t.length-1],t>e?[e,t]:[t,e]}function r(t){for(var e=[],n=Math.ceil(t[0]);n<t[1];n++)e.push(n);return 0<e.length&&0<e[0]&&e.unshift(e[0]-(e[1]-e[0])),e}function a(t){return t=t<x.length?x[t]:t,g?g(t):t}function c(c){c.each(function(){var c,g=i.select(this),x=r(o.domain()),y=g.selectAll(".tick.major").data(x,String),m=y.enter().insert("g","path").attr("class","tick major").style("opacity",1e-6),v=i.transition(y.exit()).style("opacity",1e-6).remove(),b=i.transition(y).style("opacity",1),w=o.rangeExtent?o.rangeExtent():n(o.range()),g=g.selectAll(".domain").data([0]);g.enter().append("path").attr("class","domain");var g=i.transition(g),A=o.copy(),k=this.__chart__||A;this.__chart__=A,m.append("line"),m.append("text");var M=m.select("line"),E=b.select("line"),_=y.select("text"),O=m.select("text"),D=b.select("text");switch(h=(A(1)-A(0))/2,y=f?0:h,l){case"bottom":c=t,M.attr("y2",s),O.attr("y",Math.max(s,0)+d),E.attr("x1",y).attr("x2",y).attr("y2",s),D.attr("x",0).attr("y",Math.max(s,0)+d),_.attr("dy",".71em").style("text-anchor","middle"),_.text(function(t){return x.length<p||0===t%Math.ceil(x.length/p)?a(t):""}),g.attr("d","M"+w[0]+","+u+"V0H"+w[1]+"V"+u);break;case"left":c=e,M.attr("x2",-s),O.attr("x",-(Math.max(s,0)+d)),E.attr("x2",-s).attr("y2",0),D.attr("x",-(Math.max(s,0)+d)).attr("y",h),_.attr("dy",".32em").style("text-anchor","end"),_.text(function(t){return x.length<p||0===t%Math.ceil(x.length/p)?a(t):""}),g.attr("d","M"+-u+","+w[0]+"H0V"+w[1]+"H"+-u)}if(o.ticks)m.call(c,k),b.call(c,A),v.call(c,A);else{var z=A.rangeBand()/2,v=function(t){return A(t)+z};m.call(c,v),b.call(c,v)}})}var o=i.scale.linear(),l="bottom",s=6,u=6,d=3,f=!1,p=10,h=0,g=null,x=[];return c.scale=function(t){return arguments.length?(o=t,c):o},c.orient=function(t){return arguments.length?(l=t in{top:1,right:1,bottom:1,left:1}?t+"":"bottom",c):l},c.categories=function(t){return arguments.length?(x=t,c):x},c.tickCentered=function(t){return arguments.length?(f=t,c):f},c.tickTextNum=function(t){return arguments.length?(p=t,c):p},c.tickFormat=function(t){return arguments.length?(g=t,c):g},c.tickOffset=function(){return h},c.ticks=function(){},c}function n(t){return"undefined"==typeof t}function r(t){return"undefined"!=typeof t}var a=t.c3={},i=t.d3;a.generate=function(a){function c(t,e){for(var n=a,r=0;r<t.length;r++){if(!(t[r]in n))return e;n=n[t[r]]}return n}function o(){rr=null===Cn?s():Cn,ar=l(),Un=0,Xn=(xa?Rr+ti:0)+(Bn?Bn:aa?1:40),Fn=20+(xa?0:Rr)+Va,Yn=Kn?Kn:la?fa||xa?1:40:20,$n=rr-Xn-Yn,er=ar-Un-Fn,Tn=xa?Un:ar-Rr-Va,Nn=xa?$a:Xn,jn=20+Va,tr=xa?Xn-$a-ti:$n,nr=xa?er:ar-Tn-jn,zn=ar-Va,Sn=Xn,cr=er/2,ir=.95*cr,or=Xe(qn.data.targets,"dount")?.6*ir:0}function l(){var t=null===Vn?+i.select(Rn).style("height").replace("px",""):Vn;return t>0?t:320}function s(){return+i.select(Rn).style("width").replace("px","")}function u(){return $n+2+Xn+Yn}function d(){return 40}function f(){return Xn+20}function p(){return er-Un+2}function h(){var t=xa?er:$n,e=F(pi)/F(mr.domain()),n=J();return n>1?t*e/(n-1):t}function g(){fr=xa?1:0,pr=xa?er:$n,hr=xa?0:er,gr=xa?$n:1,xr=xa?0:nr,yr=xa?tr:1,mr=x(fr,pr,r(mr)?mr.domain():void 0,function(){return Mr.tickOffset()}),vr=y(hr,gr,r(vr)?vr.domain():void 0),br=y(hr,gr,r(br)?br.domain():void 0),wr=x(fr,pr,r(pi)?pi:void 0,function(t){return 0===t%1?Or.tickOffset():0}),Ar=y(xr,yr),kr=y(xr,yr),Mr=b(mr,Wa),Er=i.svg.axis().scale(vr).orient(Ga),_r=i.svg.axis().scale(br).orient(Ja),Or=b(wr,Qa),lr=M(),sr=E(),ur=E(.98)}function x(t,e,a,c){var o=(Ia?i.time.scale():i.scale.linear()).range([t,e]);if(o.orgDomain=function(){return o.domain()},r(a)&&o.domain(a),n(c)&&(c=function(){return 0}),La){var l,s=o,o=function(t){return s(t)+c(t)};for(l in s)o[l]=s[l];o.orgDomain=function(){return s.domain()},o.domain=function(t){return arguments.length?(s.domain(t),o):(t=s.domain(),[t[0],t[1]+1])}}return o}function y(t,e){return i.scale.linear().range([t,e])}function m(t){return"y2"===w(t)?br:vr}function v(t){return"y2"===w(t)?kr:Ar}function b(t,n){var r=(La?e():i.svg.axis()).scale(t).orient(n);return r.tickFormat(A()),La?r.categories(Gr).tickCentered(Jr):r.tickOffset=function(){return 0},r}function w(t){return t in Ur?Ur[t]:"y"}function A(){var t=Ia?Ka:La?ie:function(t){return t};return Qr&&(t="function"==typeof Qr?Qr:Ia?function(t){return i.time.format(Qr)(t)}:t),t}function k(t){var e=!1;return dr(qn.data.targets).forEach(function(n){e||n.data.id!==t.data.id||(e=!0,t=n)}),e?t:null}function M(){var t=i.svg.arc().outerRadius(ir).innerRadius(or),e=function(e,n){var r;return n?t(e):(r=k(e))?t(r):"M 0 0"};return e.centroid=t.centroid,e}function E(t){var e=i.svg.arc().outerRadius(cr*(t?t:1)).innerRadius(or);return function(t){return(t=k(t))?e(t):"M 0 0"}}function _(t){t=k(t);var e,n;return e="",t&&(e=lr.centroid(t),t=e[0],e=e[1],n=Math.sqrt(t*t+e*e),e="translate("+.8*(t/n)*ir+","+.8*(e/n)*ir+")"),e}function O(t){return Sa(t,(t.endAngle-t.startAngle)/(2*Math.PI))}function D(t,e){var n=ci.selectAll(".chart-arc.target"+(t?"-"+t:"")),r=ci.selectAll(".-arc").filter(function(e){return e.data.id!==t});n.selectAll("path").transition().duration(50).attr("d",sr).transition().duration(100).attr("d",ur).each(function(t){Pe(t.data)}),e||r.style("opacity",.3)}function z(t){ci.selectAll(".chart-arc.target"+(t?"-"+t:"")).selectAll("path").transition().duration(50).attr("d",lr),ci.selectAll(".-arc").style("opacity",1)}function S(t){var e,n,r,a,c=ee(t);if(0<jr.length)for(a=re(t),t=0;t<jr.length;t++)for(n=jr[t][0],a&&c[n]&&c[n].forEach(function(t,e){c[n][e]=0>t?t:0}),e=1;e<jr[t].length;e++)r=jr[t][e],c[r]&&c[r].forEach(function(t,e){w(r)!==w(n)||!c[n]||a&&+t>0||(c[n][e]+=+t)});return i.min(Object.keys(c).map(function(t){return i.min(c[t])}))}function T(t){var e,n,r,a,c=ee(t);if(0<jr.length)for(a=ae(t),t=0;t<jr.length;t++)for(n=jr[t][0],a&&c[n]&&c[n].forEach(function(t,e){c[n][e]=t>0?t:0}),e=1;e<jr[t].length;e++)r=jr[t][e],c[r]&&c[r].forEach(function(t,e){w(r)!==w(n)||!c[n]||a&&0>+t||(c[n][e]+=+t)});return i.max(Object.keys(c).map(function(t){return i.max(c[t])}))}function N(t){var e=te(function(e){return w(e.id)===t}),n="y2"===t?ua:ea,r="y2"===t?sa:ta,n=n?n:S(e),r=r?r:T(e),a=.1*Math.abs(r-n),i=a,c=a,o="y2"===t?da:na;return o&&(n=Math.max(Math.abs(n),Math.abs(r)),r=n-o,n=o-n),"y"===t&&ca&&(i=ca.top?ca.top:a,c=ca.bottom?ca.bottom:a),"y2"===t&&ha&&(i=ha.top?ha.top:a,c=ha.bottom?ha.bottom:a),Xe(e,"bar")&&!re(e)&&(c=n),[n-c,r+i]}function j(t){return i.min(t,function(t){return i.min(t.values,function(t){return t.x})})}function U(t){return i.max(t,function(t){return i.max(t.values,function(t){return t.x})})}function X(t){var e=[j(t),U(t)];t=e[0];var e=e[1],n=La?0:.01*Math.abs(t-e);return t=Ia?new Date(t.getTime()-n):t-n,e=Ia?new Date(e.getTime()+n):e+n,[t,e]}function F(t){return t[1]-t[0]}function Y(t){for(var e=0;e<t.length;e++)if(!(t[e]in In))return!1;return!0}function q(t){for(var e=[],n=0;n<t.length;n++)t[n]in In&&e.push(W(In[t[n]]));return e}function I(t){return"start"in t?mr(Ia?Ve(t.start):t.start):0}function L(t){var e=I(t);return t=("end"in t?mr(Ia?Ve(t.end):t.end):$n)-e,0>t?0:t}function H(t){return Dr&&t===Dr||zr&&Ge(zr,t)}function P(t){return!H(t)}function R(t){Object.keys(t).forEach(function(e){zr[e]=t[e]})}function C(t){var e;return t&&(e=Nr[t.id],t.name=e?e:t.id),t}function V(t){var e,n,r=t[0],a={},i=[];for(e=1;e<t.length;e++){for(a={},n=0;n<t[e].length;n++)a[r[n]]=t[e][n];i.push(a)}return i}function B(t){var e,r,a,i=[];for(e=0;e<t.length;e++)for(a=t[e][0],r=1;r<t[e].length;r++)n(i[r-1])&&(i[r-1]={}),i[r-1][a]=t[e][r];return i}function K(e){var n=i.keys(e[0]).filter(P),r=i.keys(e[0]).filter(H);return Ia&&0===r.length?(t.alert('data.x or data.xs must be specified when axis.x.type == "timeseries"'),[]):(Ha&&n.forEach(function(t){var n=Dr?Dr:zr?zr[t]:null;qn.data.x[t]=0<=r.indexOf(n)?e.map(function(t){return t[n]}):qn.data.x[Object.keys(qn.data.x)[0]]}),n=n.map(function(t){var n=Tr(t);return{id:n,id_org:t,values:e.map(function(e,r){var a;return a=Dr?Dr:zr?zr[t]:null,a=Ia?Ve(e[a]):Ha?e[a]?e[a]:t in qn.data.x&&qn.data.x[t]&&qn.data.x[t][r]?qn.data.x[t][r]:r:r,e.x=a,{x:a,value:null===e[t]||isNaN(e[t])?null:+e[t],id:n}})}}),n.forEach(function(t){var e;t.values=t.values.sort(function(t,e){return(t.x||0===t.x?t.x:1/0)-(e.x||0===e.x?e.x:1/0)}),e=0,t.values.forEach(function(t){t.index=e++})}),Xr&&Ue(Z(n).filter(function(t){return!(t in Fr)}),Xr),n.forEach(function(t){In[t.id_org]=W(t)}),n)}function W(t){return{id:t.id,id_org:t.id_org,values:t.values.map(function(t){return{x:t.x,value:t.value,id:t.id}})}}function G(t){return t>0&&qn.data.targets[0].values[t-1]?qn.data.targets[0].values[t-1].x:void 0}function J(){return i.max(qn.data.targets,function(t){return t.values.length})}function Q(){var t,e=qn.data.targets.length,n=0;return e>1?qn.data.targets.forEach(function(e){e.values.length>n&&(t=e,n=e.values.length)}):t=e?qn.data.targets[0]:null,t}function Z(t){return t=n(t)?qn.data.targets:t,t.map(function(t){return t.id})}function $(t){var e,n=Z();for(e=0;e<n.length;e++)if(n[e]===t)return!0;return!1}function te(t){return r(t)?qn.data.targets.filter(t):qn.data.targets}function ee(t){var e={};return t.forEach(function(t){e[t.id]=[],t.values.forEach(function(n){e[t.id].push(n.value)})}),e}function ne(t,e){var n,r,a,i=Object.keys(t);for(n=0;n<i.length;n++)for(a=t[i[n]].values,r=0;r<a.length;r++)if(e(a[r].value))return!0;return!1}function re(t){return ne(t,function(t){return 0>t})}function ae(t){return ne(t,function(t){return t>0})}function ie(t){return t<Gr.length?Gr[t]:t}function ce(t){return"-shapes -shapes-"+t.id}function oe(t){return ce(t)+" -line -line-"+t.id}function le(t){return ce(t)+" -circles -circles-"+t.id}function se(t){return ce(t)+" -bars -bars-"+t.id}function ue(t){return ce(t.data)+" -arc -arc-"+t.data.id}function de(t){return ce(t)+" -area -area-"+t.id}function fe(t,e){return"-shape -shape-"+e+" -circle -circle-"+e}function pe(t,e){return"-shape -shape-"+e+" -bar -bar-"+e}function he(t,e){return"region region-"+e+" "+("classes"in t?[].concat(t.classes).join(" "):"")}function ge(t,e){return"event-rect event-rect-"+e}function xe(t){return t.value?Le(t)?.5:1:0}function ye(t){return mr(t.x)}function me(t){return mr(Ia?Ve(t.value):t.value)}function ve(t){return vr(t.value)}function be(t){return wr(t.x)}function we(t,e){var n,r=t[e].x,a=[];for(n=e-1;n>=0&&r===t[n].x;n--)a.push(t[n]);for(n=e;n<t.length&&r===t[n].x;n++)a.push(t[n]);return a}function Ae(t,e,n,r){n=n?n:0,r=r?r:t.length-1;var a=Math.floor((r-n)/2)+n;return 0<mr(t[a].x)-e[0]?r=a:n=a,1===r-n?(a=[],t[n].x&&(a=a.concat(we(t,n))),t[r].x&&(a=a.concat(we(t,r))),Me(a,e)):Ae(t,e,n,r)}function ke(t,e){var n;return n=t.map(function(t){return Ae(t.values,e)}),Me(n,e)}function Me(t,e){var n,r;return t.forEach(function(t){var a=Je(t,e);(n>a||!n)&&(n=a,r=t)}),r}function Ee(t,e){var n,r,a,i,c;0!==t.filter(function(t){return t&&t.value}).length&&(di.html(ja(t)).style("visibility","hidden").style("display","block"),n=di.property("offsetWidth"),r=di.property("offsetHeight"),xa?i=e[0]:(a=ci.property("offsetLeft"),i=a+(Bn?Bn:aa?1:40)+mr(t[0].x)+20,c=i+n,a=a+(null===Cn?s():Cn)-(Kn?Kn:la?fa||xa?1:40:20),c>a&&(i-=n+30)),n=e[1]+15+r<l()?e[1]+15:e[1]-r,di.style("top",n+"px").style("left",i+"px").style("visibility","visible"))}function _e(t){Xe(qn.data.targets,"scatter")||Fe(qn.data.targets)||li.selectAll("line.xgrid-focus").style("visibility","visible").data([t]).attr(xa?"y1":"x1",ye).attr(xa?"y2":"x2",ye)}function Oe(){li.select("line.xgrid-focus").style("visibility","hidden")}function De(t){return t.x||0===t.x?mr(t.x):null}function ze(t){return m(t.id)(t.value)}function Se(){var t,e,r={},a=0;return te(Ie).forEach(function(i){for(t=0;t<jr.length;t++)if(!(0>jr[t].indexOf(i.id)))for(e=0;e<jr[t].length;e++)if(jr[t][e]in r){r[i.id]=r[jr[t][e]];break}n(r[i.id])&&(r[i.id]=a++)}),r.__max__=a-1,r}function Te(t,e,n,r){var a=r?wr:mr;return e?function(r){var i=r.id in n?n[r.id]:0;return r.x||0===r.x?a(r.x)-t*(e/2-i):0}:function(){return 0}}function Ne(t){return function(e){return(t?v(e.id):m(e.id))(e.value)}}function je(t,e){var n=Object.keys(t);return function(r,a){var i=e?v(r.id):m(r.id),c=i(0),o=c;return te(Ie).forEach(function(e){e.id!==r.id&&t[e.id]===t[r.id]&&n.indexOf(e.id)<n.indexOf(r.id)&&0<e.values[a].value*r.value&&(o+=i(e.values[a].value)-c)}),o}}function Ue(t,e){var r=n(t)?Z():t;"string"==typeof r&&(r=[r]);for(var a=0;a<r.length;a++)Fr[r[a]]=e}function Xe(t,e){var n=!1;return t.forEach(function(t){Fr[t.id]===e&&(n=!0),t.id in Fr||"line"!==e||(n=!0)}),n}function Fe(t){return Xe(t,"pie")||Xe(t,"dount")}function Ye(t){return t="string"==typeof t?t:t.id,!(t in Fr)||"line"===Fr[t]||"spline"===Fr[t]||"area"===Fr[t]||"area-spline"===Fr[t]}function qe(t){return t="string"==typeof t?t:t.id,"spline"===Fr[t]||"area-spline"===Fr[t]}function Ie(t){return"bar"===Fr["string"==typeof t?t:t.id]}function Le(t){return"scatter"===Fr["string"==typeof t?t:t.id]}function He(t){return"pie"===Fr["string"==typeof t?t:t.id]}function Pe(t){return"dount"===Fr["string"==typeof t?t:t.id]}function Re(t){return Ie(t)?t.values:[]}function Ce(t){return Ye(t)||Le(t)?t.values:[]}function Ve(t){var e;if(!t)throw Error(t+" can not be parsed as d3.time with format "+Sr+". Maybe 'x' of this data is not defined. See data.x or data.xs option.");if(e=i.time.format(Sr).parse(t),!e)throw Error("Failed to parse '"+t+"' with format "+Sr);return e}function Be(t,e){var n=i.mouse(t),r=i.select(t),a=1*r.attr("cx"),r=1*r.attr("cy");return Math.sqrt(Math.pow(a-n[0],2)+Math.pow(r-n[1],2))<e}function Ke(t){var e=i.mouse(t),n=i.select(t);t=1*n.attr("x");var r=1*n.attr("y"),n=1*n.attr("width");return t-10<e[0]&&e[0]<t+n+10&&r-10<e[1]}function We(t,e){var n;for(n=0;n<e.length;n++)if(e[n].start<t&&t<=e[n].end)return!0;return!1}function Ge(t,e){var n=!1;return Object.keys(t).forEach(function(r){t[r]===e&&(n=!0)}),n}function Je(t,e){return Math.pow(mr(t.x)-e[0],2)+Math.pow(vr(t.value)-e[1],2)}function Qe(t,e,n){Da(t,e),li.select(".selected-circles-"+e.id).selectAll(".selected-circle-"+n).data([e]).enter().append("circle").attr("class",function(){return"selected-circle selected-circle-"+n}).attr("cx",xa?ze:De).attr("cy",xa?De:ze).attr("stroke",function(){return Ba(e.id)}).attr("r",1.4*_a).transition().duration(100).attr("r",_a)}function Ze(t,e,n){za(t,e),li.select(".selected-circles-"+e.id).selectAll(".selected-circle-"+n).transition().duration(100).attr("r",0).remove()}function $e(t,e,n,r){t?Qe(e,n,r):Ze(e,n,r)}function tn(){}function en(){}function nn(){}function rn(t){return t.filter(function(t){return null!==t.value})}function an(t,e){return(e?li.selectAll(".-circles-"+e):li).selectAll(".-circle"+(t||0===t?"-"+t:""))}function cn(t){an(t).filter(function(){return i.select(this).classed(Ln)}).classed(Ln,!1).attr("r",Aa)}function on(t){return li.selectAll(".-bar"+(t||0===t?"-"+t:""))}function ln(t,e,a,i){var c,o,l,s,u,d,f,p="M",h=[];if(r(i))for(c=0;c<i.length;c++)h[c]={},h[c].start=n(i[c].start)?t[0].x:Ia?Ve(i[c].start):i[c].start,h[c].end=n(i[c].end)?t[t.length-1].x:Ia?Ve(i[c].end):i[c].end;for(d=xa?function(t){return a(t.value)}:function(t){return e(t.x)},f=xa?function(t){return e(t.x)}:function(t){return a(t.value)},i=Ia?function(t,n,r,i){var c=t.x.getTime();return t=n.x-t.x,n=new Date(c+t*(r+i)),"M"+e(new Date(c+t*r))+" "+a(s(r))+" "+e(n)+" "+a(s(r+i))}:function(t,n,r,i){return"M"+e(l(r))+" "+a(s(r))+" "+e(l(r+i))+" "+a(s(r+i))},c=0;c<t.length;c++)if(n(h)||!We(t[c].x,h))p+=" "+d(t[c])+" "+f(t[c]);else{l=x(t[c-1].x,t[c].x),s=y(t[c-1].value,t[c].value),o=e(t[c].x)-e(t[c-1].x),u=a(t[c].value)-a(t[c-1].value),o=Math.sqrt(Math.pow(o,2)+Math.pow(u,2)),u=2/o;var g=2*u;for(o=u;1>=o;o+=g)p+=i(t[c-1],t[c],o,u)}return p}function sn(e){var n;if(fi=i.select(Rn),fi.empty())t.alert('No bind element found. Check the selector specified by "bindto" and existance of that element. Default "bindto" is "#chart".');else{if(fi.html(""),qn.data.x={},qn.data.targets=K(e),o(),g(),mr.domain(i.extent(X(qn.data.targets))),vr.domain(N("y")),br.domain(N("y2")),wr.domain(mr.domain()),Ar.domain(vr.domain()),kr.domain(br.domain()),Mr.ticks(10>e.length?e.length:10),Er.ticks(oa).outerTickSize(0).tickFormat(ia),_r.ticks(ga).outerTickSize(0).tickFormat(pa),pi=mr.domain(),ai.scale(wr),Wn&&ii.scale(mr),ci=i.select(Rn).append("svg").attr("width",$n+Xn+Yn).attr("height",er+Un+Fn).on("mouseenter",Qn).on("mouseleave",Zn),oi=ci.append("defs"),oi.append("clipPath").attr("id",Ya).append("rect").attr("y",Un).attr("width",$n).attr("height",er-Un),oi.append("clipPath").attr("id","xaxis-clip").append("rect").attr("x",-1-Xn).attr("y",-20).attr("width",u).attr("height",d),oi.append("clipPath").attr("id","yaxis-clip").append("rect").attr("x",-Xn+1).attr("y",Un-1).attr("width",f).attr("height",p),li=ci.append("g").attr("transform",Za.main),si=Pr?ci.append("g").attr("transform",Za.context):null,ui=Vr?ci.append("g").attr("transform",Za.legend):null,di=i.select(Rn).style("position","relative").append("div").style("position","absolute").style("z-index","10").style("display","none"),li.append("g").attr("class","x axis").attr("clip-path",xa?"":"url(#xaxis-clip)").attr("transform",Za.x).call(xa?Er:Mr).append("text").attr("class","-axis-x-label").attr("x",$n).attr("dy","-.5em").style("text-anchor","end").text($r),li.append("g").attr("class","y axis").attr("clip-path",xa?"url(#yaxis-clip)":"").call(xa?Mr:Er).append("text").attr("transform","rotate(-90)").attr("dy","1.2em").attr("dx","-.5em").style("text-anchor","end").text(ra),la&&li.append("g").attr("class","y2 axis").attr("transform",Za.y2).call(_r),e=li.append("g").attr("clip-path",qa).attr("class","grid"),ya&&e.append("g").attr("class","xgrids"),va&&(n=e.append("g").attr("class","xgrid-lines").selectAll(".xgrid-line").data(va).enter().append("g").attr("class","xgrid-line"),n.append("line").attr("class",function(t){return""+t["class"]}),n.append("text").attr("class",function(t){return""+t["class"]}).attr("text-anchor","end").attr("transform",xa?"":"rotate(-90)").attr("dx",xa?0:-Un).attr("dy",-5).text(function(t){return t.text})),ka&&e.append("g").attr("class","xgrid-focus").append("line").attr("class","xgrid-focus").attr("x1",xa?0:-10).attr("x2",xa?$n:-10).attr("y1",xa?-10:Un).attr("y2",xa?-10:er),ba&&e.append("g").attr("class","ygrids"),wa&&(e=e.append("g").attr("class","ygrid-lines").selectAll("ygrid-line").data(wa).enter().append("g").attr("class","ygrid-line"),e.append("line").attr("class",function(t){return""+t["class"]}),e.append("text").attr("class",function(t){return""+t["class"]}).attr("text-anchor","end").attr("transform",xa?"rotate(-90)":"").attr("dx",xa?0:-Un).attr("dy",-5).text(function(t){return t.text})),li.append("g").attr("clip-path",qa).attr("class","regions"),li.append("g").attr("clip-path",qa).attr("class","chart"),li.select(".chart").append("g").attr("class","event-rects").style("fill-opacity",0).style("cursor",Wn?"ew-resize":null),li.select(".chart").append("g").attr("class","chart-bars"),li.select(".chart").append("g").attr("class","chart-lines"),li.select(".chart").append("g").attr("class","chart-arcs").attr("transform",Za.arc).append("text").attr("class","chart-arcs-title").style("text-anchor","middle").text(Ta),Wn&&li.insert("rect",Jn?null:"g.grid").attr("class","zoom-rect").attr("width",$n).attr("height",er).style("opacity",0).style("cursor","ew-resize").call(ii).on("dblclick.zoom",null),null!==Zr&&ai.extent("function"!=typeof Zr?Zr:Zr(X())),Pr&&(si.append("g").attr("clip-path",qa).attr("class","chart"),si.select(".chart").append("g").attr("class","chart-bars"),si.select(".chart").append("g").attr("class","chart-lines"),si.append("g").attr("clip-path",qa).attr("class","x brush").call(ai).selectAll("rect").attr(xa?"width":"height",xa?tr:nr),si.append("g").attr("class","x axis").attr("transform",Za.subx).attr("clip-path",xa?"url(#yaxis-clip)":"").call(Or)),Vr&&En(qn.data.targets),bn(qn.data.targets),xn({withTransition:!1,withUpdateXDomain:!0}),Ua){if(Ia&&"string"==typeof Xa){for(Xa=Ve(Xa),e=0;e<qn.data.targets[0].values.length&&0!==qn.data.targets[0].values[e].x-Xa;e++);Xa=e}di.html(ja(qn.data.targets.map(function(t){return C(t.values[Xa])}))),di.style("top",Fa.top).style("left",Fa.left).style("display","block")}null==t.onresize&&(t.onresize=mn()),t.onresize.add&&t.onresize.add(vn)}}function un(t){t.append("rect").attr("class",ge).style("cursor",Ir&&Lr?"pointer":null).on("mouseover",function(t,e){if(!Ra&&!Fe(qn.data.targets)){var n,r,a=qn.data.targets.map(function(t){return C(t.values[e])});if(0<Object.keys(Nr).length){r=[];for(var i in Nr)for(n=0;n<a.length;n++)if(a[n].id===i){r.push(a[n]),a.shift(n);break}a=r.concat(a)}Ma&&an(e,void 0).classed(Ln,!0).attr("r",Ea),on(e).classed(Ln,!1),_e(a[0])}}).on("mouseout",function(t,e){Fe(qn.data.targets)||(Oe(),di.style("display","none"),cn(e),on(void 0).classed(Ln,!1))}).on("mousemove",function(t,e){var n;Ra||Fe(qn.data.targets)||(n=qn.data.targets.map(function(t){return C(t.values[e])}),Ee(n,i.mouse(this)),Ir&&(Lr||li.selectAll(".-shape-"+e).filter(function(t){return Hr(t)}).each(function(){var t=i.select(this).classed(Ln,!0);"circle"===this.nodeName&&t.attr("r",Ea),ci.select(".event-rect-"+e).style("cursor",null)}).filter(function(){var t=i.select(this);return"circle"===this.nodeName?Be(this,_a):"rect"===this.nodeName?Ke(this,t.attr("x"),t.attr("y")):void 0}).each(function(){var t=i.select(this);t.classed(Ln)||(t.classed(Ln,!0),"circle"===this.nodeName&&t.attr("r",_a)),ci.select(".event-rect-"+e).style("cursor","pointer")})))}).on("click",function(t,e){Fe(qn.data.targets)||(Ca?Ca=!1:li.selectAll(".-shape-"+e).each(function(t){fn(this,t,e)}))}).call(i.behavior.drag().origin(Object).on("drag",function(){pn(i.mouse(this))}).on("dragstart",function(){hn(i.mouse(this))}).on("dragend",function(){gn()})).call(ii).on("dblclick.zoom",null)}function dn(t){t.append("rect").attr("x",0).attr("y",0).attr("width",$n).attr("height",er).attr("class","event-rect").on("mouseout",function(){Fe(qn.data.targets)||(Oe(),di.style("display","none"),cn())}).on("mousemove",function(){var t,e,n;Ra||Fe(qn.data.targets)||(t=i.mouse(this),e=ke(qn.data.targets,t),n=[C(e)],Ee(n,t),Ma&&(cn(),an(e.index,e.id).classed(Ln,!0).attr("r",Ea)),_e(n[0]),100>Je(e,t)?ci.select(".event-rect").style("cursor","pointer"):ci.select(".event-rect").style("cursor",null))}).on("click",function(){var t,e;Fe(qn.data.targets)||(t=i.mouse(this),e=ke(qn.data.targets,t),100>Je(e,t)&&li.select(".-circles-"+e.id).select(".-circle-"+e.index).each(function(){fn(this,e,e.index)}))}).call(i.behavior.drag().origin(Object).on("drag",function(){pn(i.mouse(this))}).on("dragstart",function(){hn(i.mouse(this))}).on("dragend",function(){gn()})).call(ii).on("dblclick.zoom",null)}function fn(t,e,n){var r,a=i.select(t),c=a.classed(Hn),o=!1;"circle"===t.nodeName?(o=Be(t,1.5*_a),r=$e):"rect"===t.nodeName&&(o=Ke(t),r=nn),(Lr||o)&&(Ir&&Hr(e)&&(a.classed(Hn,!c),r(!c,a,e,n)),Oa(e,a))}function pn(t){var e,n,r,a,c,o,l;Fe(qn.data.targets)||!Ir||Wn&&!ii.altDomain||(e=Pa[0],n=Pa[1],r=t[0],t=t[1],a=Math.min(e,r),c=Math.max(e,r),o=Lr?Un:Math.min(n,t),l=Lr?er:Math.max(n,t),li.select(".dragarea").attr("x",a).attr("y",o).attr("width",c-a).attr("height",l-o),li.selectAll(".-shapes").selectAll(".-shape").filter(function(t){return Hr(t)}).each(function(t,e){var n,r,s,u,d=i.select(this),f=d.classed(Hn),p=d.classed(Pn);n=!1,"circle"===this.nodeName?(n=1*d.attr("cx"),r=1*d.attr("cy"),u=$e,n=n>a&&c>n&&r>o&&l>r):"rect"===this.nodeName&&(n=1*d.attr("x"),r=1*d.attr("y"),s=1*d.attr("width"),u=nn,n=n+s>a&&c>n&&l>r),n^p&&(d.classed(Pn,!p),d.classed(Hn,!f),u(!f,d,t,e))}))}function hn(t){!Fe(qn.data.targets)&&Ir&&(Pa=t,li.select(".chart").append("rect").attr("class","dragarea").style("opacity",.1),Ra=!0)}function gn(){!Fe(qn.data.targets)&&Ir&&(li.select(".dragarea").transition().duration(100).style("opacity",0).remove(),li.selectAll(".-shape").classed(Pn,!1),Ra=!1)}function xn(t){var e,n,a,c,o,l=Se(),s=l.__max__+1,u=Fe(qn.data.targets);if(t=r(t)?t:{},n=r(t.withY)?t.withY:!0,a=r(t.withSubchart)?t.withSubchart:!0,o=r(t.withTransition)?t.withTransition:!0,e=r(t.withUpdateXDomain)?t.withUpdateXDomain:!1,t=r(t.withUpdateOrgXDomain)?t.withUpdateOrgXDomain:!1,o=o?250:0,t&&(mr.domain(i.extent(X(qn.data.targets))),pi=mr.domain(),ii.scale(mr).updateScaleExtent(),wr.domain(mr.domain()),ai.scale(wr)),e&&(mr.domain(ai.empty()?pi:ai.extent()),Wn&&ii.scale(mr).updateScaleExtent()),vr.domain(N("y")),br.domain(N("y2")),li.select(".x.axis").transition().duration(xa?o:0).call(xa?Er:Mr).style("opacity",u?0:1),li.select(".y.axis").transition().duration(xa?0:o).call(xa?Mr:Er).style("opacity",u?0:1),li.select(".y2.axis").transition().call(_r).style("opacity",u?0:1),li.select(".x.axis .-axis-x-label").attr("x",$n),Ar.domain(vr.domain()),kr.domain(br.domain()),di.style("display","none"),li.select("line.xgrid-focus").style("visibility","hidden").attr("y2",er),ya){if("year"===ma)for(e=[],t=X(),u=t[0].getFullYear(),t=t[1].getFullYear();t>=u;u++)e.push(new Date(u+"-01-01 00:00:00"));else e=mr.ticks(10);e=li.select(".xgrids").selectAll(".xgrid").data(e),e.enter().append("line").attr("class","xgrid"),e.attr("x1",xa?0:function(t){return mr(t)-Mr.tickOffset()}).attr("x2",xa?$n:function(t){return mr(t)-Mr.tickOffset()}).attr("y1",xa?function(t){return mr(t)-Mr.tickOffset()}:Un).attr("y2",xa?function(t){return mr(t)-Mr.tickOffset()}:er).style("opacity",function(){return+i.select(this).attr(xa?"y1":"x1")===(xa?er:0)?0:1}),e.exit().remove()}va&&(e=li.selectAll(".xgrid-lines"),e.selectAll("line").transition().duration(o).attr("x1",xa?0:me).attr("x2",xa?$n:me).attr("y1",xa?me:Un).attr("y2",xa?me:er),e.selectAll("text").attr("x",xa?$n:0).attr("y",me)),n&&ba&&(e=li.select(".ygrids").selectAll(".ygrid").data(vr.ticks(10)),e.enter().append("line").attr("class","ygrid"),e.attr("x1",xa?vr:0).attr("x2",xa?vr:$n).attr("y1",xa?0:vr).attr("y2",xa?er:vr),e.exit().remove()),n&&wa&&(n=li.select(".ygrid-lines"),n.selectAll("line").transition().duration(o).attr("x1",xa?ve:0).attr("x2",xa?ve:$n).attr("y1",xa?0:ve).attr("y2",xa?er:ve),n.selectAll("text").attr("x",xa?0:$n).attr("y",ve)),n=function(t){var e=La?s?1.2*Mr.tickOffset()/s:0:.6*((xa?er:$n)*(t?1:F(pi)/F(mr.domain()))/(J()-1)),n=Te(e,s,l,!!t),r=Ne(!!t),a=je(l,!!t),i=t?v:m;return function(t,c){var o=i(t.id)(0),l=a(t,c)||o,o=[[n(t),l],[n(t),r(t)-(o-l)],[n(t)+e,r(t)-(o-l)],[n(t)+e,l]],l=xa?1:0,s=xa?0:1;return"M "+o[0][l]+","+o[0][s]+" L"+o[1][l]+","+o[1][s]+" L"+o[2][l]+","+o[2][s]+" L"+o[3][l]+","+o[3][s]+" z"}},e=li.selectAll(".-bars").selectAll(".-bar").data(Re),e.enter().append("path").attr("d",n(!1)).style("stroke","none").style("opacity",0).style("fill",function(t){return Ba(t.id)}).attr("class",pe),e.transition().duration(o).attr("d",n(!1)).style("opacity",1),e.exit().transition().duration(o).style("opacity",0).remove(),li.selectAll(".chart-line").select(".-line").transition().duration(o).attr("d",ei),li.selectAll(".-area").transition().duration(o).attr("d",ni),e=li.selectAll(".-circles").selectAll(".-circle").data(Ce),e.enter().append("circle").attr("class",fe).attr("r",Aa),e.transition().duration(o).style("opacity",xe).attr("cx",xa?ze:De).attr("cy",xa?De:ze),e.exit().remove(),li.selectAll(".chart-arc").select(".-arc").style("opacity",function(t){return t===this._current?0:1}).transition().duration(o).attrTween("d",function(t){if(t=k(t),!t)return function(){return"M 0 0"};var e=i.interpolate(this._current,t);return this._current=e(0),function(t){return t=e(t),He(t.data)||Pe(t.data)?lr(t,!0):"M 0 0"}}).style("opacity",1),li.selectAll(".chart-arc").select("text").attr("transform",_).attr("opacity",0).transition().duration(o).text(O).attr("opacity",function(t){return He(t.data)||Pe(t.data)?1:0}),Pr&&(null!==i.event&&"zoom"===i.event.type&&ai.extent(mr.orgDomain()).update(),a&&(si.select(".x.axis").transition().duration(xa?o:0).call(Or),ai.empty()||ai.extent(mr.orgDomain()).update(),a=si.selectAll(".-bars").selectAll(".-bar").data(Re),a.enter().append("path").attr("d",n(!0)).style("stroke","none").style("fill",function(t){return Ba(t.id)}).attr("class",pe),a.style("opacity",0).transition().duration(o).attr("d",n(!0)).style("opacity",1),a.exit().transition().duration(o).style("opacity",0).remove(),si.selectAll(".-line").transition().duration(o).attr("d",ri))),li.selectAll(".selected-circles").filter(function(t){return Ie(t)}).selectAll("circle").remove(),li.selectAll(".selected-circle").transition().duration(o).attr("cx",xa?ze:De).attr("cy",xa?De:ze),zr?(n=li.select(".event-rects").selectAll(".event-rect").data([0]),dn(n.enter()),n.attr("x",0).attr("y",0).attr("width",$n).attr("height",er)):(Ha?(c=function(t,e){var n=G(e),r=e<J()-1?qn.data.targets[0].values[e+1].x:void 0;return(mr(r?r:t.x+50)-mr(n?n:t.x-50))/2},a=function(t,e){var n=G(e);return(mr(t.x)+mr(n?n:t.x-50))/2}):(c=h(),a=function(t){return mr(t.x)-c/2}),n=Q(),li.select(".event-rects").datum(n?n.values:[]),n=li.select(".event-rects").selectAll(".event-rect").data(function(t){return t}),un(n.enter()),n.attr("class",ge).attr("x",xa?0:a).attr("y",xa?a:0).attr("width",xa?$n:c).attr("height",xa?c:er),n.exit().remove()),a=li.select(".regions").selectAll("rect.region").data(Na),a.enter().append("rect"),a.attr("class",he).attr("x",xa?0:I).attr("y",xa?I:Un).attr("width",xa?$n:L).attr("height",xa?L:er).style("fill-opacity",function(t){return r(t.opacity)?t.opacity:.1}),a.exit().transition().duration(o).style("fill-opacity",0).remove()}function yn(){"mousemove"===i.event.sourceEvent.type&&ii.altDomain?(mr.domain(ii.altDomain),ii.scale(mr).updateScaleExtent()):(La&&mr.orgDomain()[0]===pi[0]&&mr.domain([pi[0]-1e-10,mr.orgDomain()[1]]),xn({withTransition:!1,withY:!1,withSubchart:!1}),"mousemove"===i.event.sourceEvent.type&&(Ca=!0))}function mn(){function t(){e.forEach(function(t){t()})}var e=[];return t.add=function(t){e.push(t)},t}function vn(){o(),g(),ai.scale(wr),Wn&&ii.scale(mr),ci.attr("width",rr).attr("height",ar),ci.select("#"+Ya).select("rect").attr("width",$n).attr("height",er),ci.select("#xaxis-clip").select("rect").attr("width",u),ci.select(".zoom-rect").attr("width",$n).attr("height",er),li.select(".x.axis").attr("transform",Za.x),li.select(".y2.axis").attr("transform",Za.y2),li.select(".chart-arcs").attr("transform",Za.arc),Pr&&(si.attr("transform",Za.context),si.select(".x.axis").attr("transform",Za.subx)),Vr&&(ui.attr("transform",Za.legend),En(qn.data.targets,{withTransition:!1})),xn({withTransition:!1,withUpdateXDomain:!0})}function bn(t){var e;li.select(".chart-bars").selectAll(".chart-bar").data(t).enter().append("g").attr("class",function(t){return"chart-bar target target-"+t.id}).style("pointer-events","none").style("opacity",0).append("g").attr("class",se).style("fill",function(t){return Ba(t.id)}).style("stroke",function(t){return Ba(t.id)}).style("stroke-width",0).style("cursor",function(t){return Hr(t)?"pointer":null}),e=li.select(".chart-lines").selectAll(".chart-line").data(t).enter().append("g").attr("class",function(t){return"chart-line target target-"+t.id}).style("pointer-events","none").style("opacity",0),e.append("path").attr("class",oe).style("stroke",function(t){return Ba(t.id)}),e.append("path").attr("class",de).style("fill",function(t){return Ba(t.id)}),e.append("g").attr("class",function(t){return"selected-circles selected-circles-"+t.id}),e.append("g").attr("class",le).style("fill",function(t){return Ba(t.id)}).style("cursor",function(t){return Hr(t)?"pointer":null}),t.forEach(function(t){li.selectAll(".selected-circles-"+t.id).selectAll(".selected-circle").each(function(e){e.value=t.values[e.x].value})}),e=li.select(".chart-arcs").selectAll(".chart-arc").data(dr(t)).enter().append("g").attr("class",function(t){return"chart-arc target target-"+t.data.id}).style("opacity",0),e.append("path").attr("class",ue).style("fill",function(t){return Ba(t.data.id)}).style("cursor",function(t){return Hr(t)?"pointer":null
}).each(function(t){this._current=t}).on("mouseover",function(t){D(t.data.id),An(t.data.id)}).on("mouseout",function(t){z(t.data.id),Mn()}),e.append("text").attr("dy",".35em").style("text-anchor","middle").style("pointer-events","none"),Pr&&(e=si.select(".chart-bars").selectAll(".chart-bar").data(t),e=e.enter().append("g").attr("class",function(t){return"chart-bar target target-"+t.id}).style("opacity",0),e.append("g").attr("class",se).style("fill",function(t){return Ba(t.id)}),e=si.select(".chart-lines").selectAll(".chart-line").data(t),e=e.enter().append("g").attr("class",function(t){return"chart-line target target-"+t.id}).style("opacity",0),e.append("path").attr("class",oe).style("stroke",function(t){return Ba(t.id)})),Vr&&En(t),ci.selectAll(".target").transition().style("opacity",1)}function wn(t,e){qn.data.targets.forEach(function(e){for(var n=0;n<t.length;n++)if(e.id===t[n].id){e.values=t[n].values,t.splice(n,1);break}}),qn.data.targets=qn.data.targets.concat(t),bn(qn.data.targets),xn({withUpdateOrgXDomain:!0,withUpdateXDomain:!0}),e()}function An(t){var e=ci.selectAll(".legend-item"),n=function(e){return!t||e===t};e.filter(function(t){return!n(t)}).transition().duration(100).style("opacity",.3),e.filter(n).transition().duration(100).style("opacity",1)}function kn(t){var e=ci.selectAll(".legend-item"),n=function(e){return!t||e===t};e.filter(function(t){return!n(t)}).transition().duration(100).style("opacity",1),e.filter(n).transition().duration(100).style("opacity",.3)}function Mn(){ci.selectAll(".legend-item").transition().duration(100).style("opacity",1)}function En(t,e){var a,i,c=Z(t),o=$n/2-Br*Object.keys(t).length/2;e=n(e)?{}:e,i=r(e.withTransition)?e.withTransition:!0,a=ui.selectAll(".legend-item").data(c).enter().append("g").attr("class",function(t){return"legend-item legend-item-"+t}).style("cursor","pointer").on("click",function(t){Kr(t)}).on("mouseover",function(t){An(t),qn.focus(t)}).on("mouseout",function(){Mn(),qn.revert()}),a.append("rect").attr("class","legend-item-event").style("fill-opacity",0).attr("x",-200).attr("y",function(){return Va/2-16}).attr("width",Br).attr("height",24),a.append("rect").attr("class","legend-item-tile").style("pointer-events","none").style("fill",function(t){return Ba(t)}).attr("x",-200).attr("y",function(){return Va/2-9}).attr("width",10).attr("height",10),a.append("text").text(function(t){return r(Nr[t])?Nr[t]:t}).style("pointer-events","none").attr("x",-200).attr("y",function(){return Va/2}),ui.selectAll("rect.legend-item-event").data(c).transition().duration(i?250:0).attr("x",function(t,e){return o+Br*e}),ui.selectAll("rect.legend-item-tile").data(c).transition().duration(i?250:0).attr("x",function(t,e){return o+Br*e}),ui.selectAll("text").data(c).transition().duration(i?250:0).attr("x",function(t,e){return o+Br*e+14})}function _n(t){return r(t)?".target-"+t:".target"}function On(t){return $(t.id)}function Dn(t){return"data"in t&&$(t.data.id)}var zn,Sn,Tn,Nn,jn,Un,Xn,Fn,Yn,qn={data:{}},In={},Ln="_expanded_",Hn="_selected_",Pn="_included_",Rn=c(["bindto"],"#chart"),Cn=c(["size","width"],null),Vn=c(["size","height"],null),Bn=c(["padding","left"],null),Kn=c(["padding","right"],null),Wn=c(["zoom","enabled"],!1),Gn=c(["zoom","extent"],null),Jn=c(["zoom","privileged"],!1),Qn=c(["onenter"],function(){}),Zn=c(["onleave"],function(){});if(!("data"in a))throw Error("data is required in config");var $n,tr,er,nr,rr,ar,ir,cr,or,lr,sr,ur,dr,fr,pr,hr,gr,xr,yr,mr,vr,br,wr,Ar,kr,Mr,Er,_r,Or,Dr=c(["data","x"],null),zr=c(["data","xs"],null),Sr=c(["data","x_format"],"%Y-%m-%d"),Tr=c(["data","id_converter"],function(t){return t}),Nr=c(["data","names"],{}),jr=c(["data","groups"],[]),Ur=c(["data","axes"],{}),Xr=c(["data","type"],null),Fr=c(["data","types"],{}),Yr=c(["data","regions"],{}),qr=c(["data","colors"],{}),Ir=c(["data","selection","enabled"],!1),Lr=c(["data","selection","grouped"],!1),Hr=c(["data","selection","isselectable"],function(){return!0}),Pr=c(["subchart","show"],!1),Rr=Pr?c(["subchart","size","height"],60):0,Cr=c(["color","pattern"],null),Vr=c(["legend","show"],!0),Br=c(["legend","item","width"],80),Kr=c(["legend","item","onclick"],function(){}),Wr=c(["axis","x","type"],"indexed"),Gr=c(["axis","x","categories"],[]),Jr=c(["axis","x","tick","centered"],!1),Qr=c(["axis","x","tick","format"],null),Zr=c(["axis","x","default"],null),$r=c(["axis","x","label"],null),ta=c(["axis","y","max"],null),ea=c(["axis","y","min"],null),na=c(["axis","y","center"],null),ra=c(["axis","y","label"],null),aa=c(["axis","y","inner"],!1),ia=c(["axis","y","tick","format"],function(t){return t}),ca=c(["axis","y","padding"],null),oa=c(["axis","y","ticks"],10),la=c(["axis","y2","show"],!1),sa=c(["axis","y2","max"],null),ua=c(["axis","y2","min"],null),da=c(["axis","y2","center"],null),fa=c(["axis","y2","inner"],!1),pa=c(["axis","y2","tick","format"],function(t){return t}),ha=c(["axis","y2","padding"],null),ga=c(["axis","y2","ticks"],10),xa=c(["axis","rotated"],!1),ya=c(["grid","x","show"],!1),ma=c(["grid","x","type"],"tick"),va=c(["grid","x","lines"],null),ba=c(["grid","y","show"],!1),wa=c(["grid","y","lines"],null),Aa=c(["point","show"],!0)?c(["point","r"],2.5):0,ka=c(["point","focus","line","enabled"],!0),Ma=c(["point","focus","expand","enabled"],!0),Ea=c(["point","focus","expand","r"],Ma?4:Aa),_a=c(["point","focus","select","r"],8),Oa=c(["point","onclick"],function(){}),Da=c(["point","onselected"],function(){}),za=c(["point","onunselected"],function(){}),Sa=c(["arc","label","format"],function(t,e){return(100*e).toFixed(1)+"%"}),Ta=c(["arc","title"],""),Na=c(["regions"],[]),ja=c(["tooltip","contents"],function(t){var e,n,a,i="<table class='-tooltip'><tr><th colspan='2'>"+A()(t[0].x)+"</th></tr>";for(e=0;e<t.length;e++)t[e]&&(t[e].value||0===t[e].value)&&(n=r(t[e].value)?(Math.round(100*t[e].value)/100).toFixed(2):"-",a=t[e].name,i+="<tr class='-tooltip-name-"+t[e].id+"'><td class='name'><span style='background-color:"+Ba(t[e].id)+"'></span>"+a+"</td><td class='value'>"+n+"</td></tr>");return i+"</table>"}),Ua=c(["tooltip","init","show"],!1),Xa=c(["tooltip","init","x"],0),Fa=c(["tooltip","init","position"],{top:"0px",left:"50px"}),Ya=Rn.replace("#","")+"-clip",qa="url(#"+Ya+")",Ia="timeseries"===Wr,La="categorized"===Wr,Ha=!Ia&&(Dr||zr),Pa=null,Ra=!1,Ca=!1,Va=Vr?40:0,Ba=function(t,e){var n=[],r=null!==e?e:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");return function(e){return e in t?t[e]:(-1===n.indexOf(e)&&n.push(e),r[n.indexOf(e)%r.length])}}(qr,Cr),Ka=function(){var t=[[i.time.format("%Y/%-m/%-d"),function(){return!0}],[i.time.format("%-m/%-d"),function(t){return t.getMonth()}],[i.time.format("%-m/%-d"),function(t){return 1!==t.getDate()}],[i.time.format("%-m/%-d"),function(t){return t.getDay()&&1!==t.getDate()}],[i.time.format("%I %p"),function(t){return t.getHours()}],[i.time.format("%I:%M"),function(t){return t.getMinutes()}],[i.time.format(":%S"),function(t){return t.getSeconds()}],[i.time.format(".%L"),function(t){return t.getMilliseconds()}]];return function(e){for(var n=t.length-1,r=t[n];!r[1](e);)r=t[--n];return r[0](e)}}(),Wa=xa?"left":"bottom",Ga=xa?aa?"top":"bottom":aa?"right":"left",Ja=xa?fa?"bottom":"top":fa?"left":"right",Qa=xa?"left":"bottom",Za={main:function(){return"translate("+Xn+","+Un+")"},context:function(){return"translate("+Nn+","+Tn+")"},legend:function(){return"translate("+Sn+","+zn+")"},y2:function(){return"translate("+(xa?0:$n)+","+(xa?10:0)+")"},x:function(){return"translate(0,"+er+")"},subx:function(){return"translate(0,"+(xa?0:nr)+")"},arc:function(){return"translate("+$n/2+","+er/2+")"}},$a=40,ti=20;dr=i.layout.pie().value(function(t){return t.values.reduce(function(t,e){return t+e.value},0)});var ei=function(){var t=i.svg.line().x(xa?function(t){return m(t.id)(t.value)}:ye).y(xa?ye:function(t){return m(t.id)(t.value)});return function(e){var n,r=rn(e.values);return Ye(e)?(t.interpolate(qe(e)?"cardinal":"linear"),Yr[e.id]?ln(r,mr,m(e.id),Yr[e.id]):t(r)):(n=mr(r[0].x),e=m(e.id)(r[0].value),xa?"M "+e+" "+n:"M "+n+" "+e)}}(),ni=function(){var t;return t=xa?i.svg.area().x0(function(t){return m(t.id)(0)}).x1(function(t){return m(t.id)(t.value)}).y(ye):i.svg.area().x(ye).y0(function(t){return m(t.id)(0)}).y1(function(t){return m(t.id)(t.value)}),function(e){var n,r=rn(e.values);return Xe([e],"area")||Xe([e],"area-spline")?(t.interpolate(qe(e)?"cardinal":"linear"),t(r)):(n=mr(r[0].x),e=m(e.id)(r[0].value),xa?"M "+e+" "+n:"M "+n+" "+e)}}(),ri=function(){var t=i.svg.line().x(xa?function(t){return v(t.id)(t.value)}:be).y(xa?be:function(t){return v(t.id)(t.value)});return function(e){var n=rn(e.values);return Ye(e)?t(n):"M "+wr(n[0].x)+" "+v(e.id)(n[0].value)}}(),ai=i.svg.brush().on("brush",function(){xn({withTransition:!1,withY:!1,withSubchart:!1,withUpdateXDomain:!0})}),ii=i.behavior.zoom().on("zoomstart",function(){ii.altDomain=i.event.sourceEvent.altKey?mr.orgDomain():null}).on("zoom",Wn?yn:null);ai.update=function(){return si&&si.select(".x.brush").call(this),this},ai.scale=function(t){return xa?this.y(t):this.x(t)},ii.scale=function(t){return xa?this.y(t):this.x(t)},ii.orgScaleExtent=function(){var t=Gn?Gn:[1,10];return[t[0],Math.max(J()/t[1],t[1])]},ii.updateScaleExtent=function(){var t=F(mr.orgDomain())/F(pi),e=this.orgScaleExtent();return this.scaleExtent([e[0]*t,e[1]*t]),this};var ci,oi,li,si,ui,di,fi,pi;if(qn.focus=function(t){var e=ci.selectAll(_n(t)),n=e.filter(On),e=e.filter(Dn);qn.revert(),qn.defocus(),n.classed("focused",!0).transition().duration(100).style("opacity",1),e.transition().duration(100).style("opacity",1),Fe(qn.data.targets)&&D(t,!0),An(t)},qn.defocus=function(t){var e=ci.selectAll(_n(t)),n=e.filter(On),e=e.filter(Dn);qn.revert(),n.classed("focused",!1).transition().duration(100).style("opacity",.3),e.transition().duration(100).style("opacity",.3),Fe(qn.data.targets)&&z(t),kn(t)},qn.revert=function(t){var e=ci.selectAll(_n(t)),n=e.filter(On),e=e.filter(Dn);n.classed("focused",!1).transition().duration(100).style("opacity",1),e.transition().duration(100).style("opacity",1),Fe(qn.data.targets)&&z(t),Mn()},qn.show=function(t){ci.selectAll(_n(t)).transition().style("opacity",1)},qn.hide=function(t){ci.selectAll(_n(t)).transition().style("opacity",0)},qn.unzoom=function(){ai.clear().update(),xn({withUpdateXDomain:!0})},qn.load=function(t){if("function"!=typeof t.done&&(t.done=function(){}),t.xs&&R(t.xs),"categories"in t&&La&&(Gr=t.categories,Mr.categories(Gr)),"cacheIds"in t&&Y(t.cacheIds))wn(q(t.cacheIds),t.done);else if("data"in t)wn(K(t.data),t.done);else if("url"in t)i.csv(t.url,function(e,n){wn(K(n),t.done)});else if("rows"in t)wn(K(V(t.rows)),t.done);else{if(!("columns"in t))throw Error("url or rows or columns is required.");wn(K(B(t.columns)),t.done)}},qn.unload=function(t){qn.data.targets=qn.data.targets.filter(function(e){return e.id!==t}),ci.selectAll(".target-"+t).transition().style("opacity",0).remove(),Vr&&(ci.selectAll(".legend-item-"+t).remove(),En(qn.data.targets)),0<qn.data.targets.length&&xn({withUpdateOrgXDomain:!0,withUpdateXDomain:!0})},qn.selected=function(t){return t=r(t)?"-"+t:"",i.merge(li.selectAll(".-shapes"+t).selectAll(".-shape").filter(function(){return i.select(this).classed(Hn)}).map(function(t){return t.map(function(t){return t.__data__})}))},qn.select=function(t,e,a){Ir&&li.selectAll(".-shapes").selectAll(".-shape").each(function(c,o){var l="circle"===this.nodeName?Qe:tn,s="circle"===this.nodeName?Ze:en;0<=e.indexOf(o)?Hr(c)&&(Lr||n(t)||0<=t.indexOf(c.id))&&l(i.select(this).classed(Hn,!0),c,o):r(a)&&a&&s(i.select(this).classed(Hn,!1),c,o)})},qn.unselect=function(t,e){Ir&&li.selectAll(".-shapes").selectAll(".-shape").each(function(r,a){var c="circle"===this.nodeName?Ze:en;(n(e)||0<=e.indexOf(a))&&Hr(r)&&(Lr||n(t)||0<=t.indexOf(r.id))&&c(i.select(this).classed(Hn,!1),r,a)})},qn.toLine=function(t){Ue(t,"line"),xn()},qn.toSpline=function(t){Ue(t,"spline"),xn()},qn.toBar=function(t){Ue(t,"bar"),xn()},qn.toScatter=function(t){Ue(t,"scatter"),xn()},qn.groups=function(t){return n(t)?jr:(jr=t,xn(),jr)},qn.regions=function(t){return n(t)?Na:(Na=t,xn(),Na)},qn.regions.add=function(t){return n(t)?Na:(Na=Na.concat(t),xn(),Na)},qn.regions.remove=function(t,e){var n=[].concat(t);return e=r(e)?e:{},n.forEach(function(t){var n=ci.selectAll("."+t);r(e.duration)&&(n=n.transition().duration(e.duration).style("fill-opacity",0)),n.remove(),Na=Na.filter(function(e){return 0>e.classes.indexOf(t)})}),Na},qn.data.get=function(t){return t=qn.data.getAsTarget(t),r(t)?t.values.map(function(t){return t.value}):void 0},qn.data.getAsTarget=function(t){var e=te(function(e){return e.id===t});return 0<e.length?e[0]:void 0},qn.destroy=function(){qn.data.targets=void 0,qn.data.x={},fi.html(""),t.onresize=null},"url"in a.data)i.csv(a.data.url,function(t,e){sn(e)});else if("rows"in a.data)sn(V(a.data.rows));else{if(!("columns"in a.data))throw Error("url or rows or columns is required.");sn(B(a.data.columns))}return qn}}(window);